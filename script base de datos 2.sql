...
-- =====================================================
-- TABLAS FALTANTES PARA COMPATIBILIDAD CON JPA/HIBERNATE
-- =====================================================

-- Tabla para Roles (Spring Security)
CREATE TABLE roles (
...
-- Tabla de unión para la relación Usuario <-> Rol
...
-- Tabla para la herencia de Administrador
CREATE TABLE administradores (
    id NUMBER(19,0) NOT NULL,
    nivel_acceso NUMBER(10,0),
